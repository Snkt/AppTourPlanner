<%-- 
    Document   : profile
    Created on : 10 Jan, 2014, 2:56:55 PM
    Author     : sanket
--%>
...
<head>
	...
	<link href="<%=request.getContextPath()%>/assets/plugins/bootstrap-fileupload/bootstrap-fileupload.css" rel="stylesheet" type="text/css" />
	<link href="<%=request.getContextPath()%>/assets/plugins/chosen-bootstrap/chosen/chosen.css" rel="stylesheet" type="text/css" />
	<link href="<%=request.getContextPath()%>/assets/css/pages/profile.css" rel="stylesheet" type="text/css" />
...
<!--										<div class="pull-left">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/assets/plugins/bootstrap-fileupload/bootstrap-fileupload.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/assets/plugins/chosen-bootstrap/chosen/chosen.jquery.min.js"></script>
